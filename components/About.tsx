        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          ...
          <div className="w-full lg:w-1/2">
            ...
            <div className="prose prose-lg text-gray-600 mb-8">
              ...
              <p className="mb-4">
                Since 1999, we have been located in the historic Old Willunga Veterinary building at Lot 102 Main Road. Our spacious facility is fully air-conditioned, offering excellent ventilation and natural lighting to ensure a hygienic, comfortable, and stress-free environment for every pet.
              </p>
              <p>
