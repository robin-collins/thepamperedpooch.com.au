    ...
    <section id="contact" className="py-24 bg-white relative">
          ...
          <div className="bg-neutral p-8 md:p-10 rounded-3xl shadow-soft-md border border-neutral-200">
             ...
             <form onSubmit={initiateVerification} className="space-y-5">
                ...
                <button 
                  ...
                  className={`w-full bg-primary text-white font-bold py-4 rounded-xl shadow-glow-primary hover:bg-primary-hover transition-all transform hover:-translate-y-1 flex justify-center items-center ${
      ...
      {(step === 'verify' || step === 'success') && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <div 
            className={`bg-white rounded-3xl p-8 max-w-md w-full relative z-10 shadow-2xl transition-all duration-700 ease-in-out ${
              step === 'success' ? 'transform scale-0 rotate-12 opacity-0' : 'transform scale-100 opacity-100'
            }`}
          >
                ...
                <div className="flex justify-between items-center text-xs text-gray-500 mt-2 px-2">
                   ...
                   <button 
                      ...
                      className={`font-medium transition-colors ${
                        resendCooldown > 0 ? 'text-gray-300 cursor-not-allowed' : 'text-primary hover:underline'
                      }`}
                   >
